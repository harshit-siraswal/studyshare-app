...
class AppTheme {
  ...
  static const double chatBubbleRadiusLarge = 22;
  static const double chatBubbleRadiusSmall = 6;
  static const double chatBubbleVerticalPadding = 5;
  static const double chatBubbleHorizontalPadding = 2;
  ...
  // ============ STATIC ALIASES (NON-ADAPTIVE) ============
  // These are fixed compile-time aliases. Prefer runtime helpers like
  // getTextColor/getMutedColor when you need theme-aware values.
  ...
  static ThemeData lightTheme(ColorScheme? dynamicScheme) {
    ...
    return ThemeData(
      ...
      scaffoldBackgroundColor: dynamicScheme != null
          ? scheme.surface
          : lightBackground,
      ...
      appBarTheme: AppBarTheme(
        backgroundColor: dynamicScheme != null
            ? scheme.surface
            : lightBackground,
        foregroundColor: scheme.onSurface,
        elevation: 0,
      ...
      outlinedButtonTheme: _outlinedButtonTheme(
        scheme,
        dynamicScheme != null ? scheme.outlineVariant : lightBorder,
      ),
  ...
  static ThemeData darkTheme(ColorScheme? dynamicScheme) {
    ...
    return ThemeData(
      ...
      outlinedButtonTheme: _outlinedButtonTheme(
        scheme,
        dynamicScheme != null ? scheme.outlineVariant : darkBorder,
      ),
